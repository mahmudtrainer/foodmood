...
<div className=' w-72 mx-auto'>
    ...
    <input type="text" className='border-2 p-1 rounded-xl border-black' />
</div>
<div className=' w-72 mx-auto'>
    <label htmlFor="" className='text-lg font-semibold'>Comments<span className='text-red-500'>*</span></label> <br />
    <textarea name="" className='border-2 p-1 rounded-xl border-black w-72 h-20' id=""></textarea>
</div>
<button className='btn bg-red-500 text-white w-2/3 mx-auto flex justify-center my-10'>Submit</button>
                </div>
            </div>
